<?php
$metadata['https://rcauth.stfc.ac.uk/'] = array (
  ...
  array (
    ...
    array (
      ...
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SAML2/POST',
      'index' => 1,
    ),
    1 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST-SimpleSign',
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SAML2/POST-SimpleSign',
      'index' => 2,
    ),
    2 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact',
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SAML2/Artifact',
      'index' => 3,
    ),
    3 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:PAOS',
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SAML2/ECP',
      'index' => 4,
    ),
  ),
  'SingleLogoutService' =>
  array (
    ...
    array (
      ...
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SLO/SOAP',
    ),
    1 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SLO/Redirect',
    ),
    2 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST',
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SLO/POST',
    ),
    3 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact',
      'Location' => 'https://rcauth.stfc.ac.uk/Shibboleth.sso/SLO/Artifact',
    ),
  ),
  'attributes' =>
  array (
